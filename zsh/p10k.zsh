# Generated by Powerlevel10k configuration wizard on 2021-06-28 at 00:12 JST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 25238.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 24h time, angled separators, blurred heads, sharp tails, 2 lines, dotted, full frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND='#4d52ff'
  ...
  typeset -g POWERLEVEL9K_EXAMPLE_FOREGROUND='#ffffff'
  typeset -g POWERLEVEL9K_EXAMPLE_BACKGROUND='#4d52ff'
